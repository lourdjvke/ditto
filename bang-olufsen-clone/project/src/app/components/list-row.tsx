...
export default function ListRow({ d, cids }: { d: ListRowData; cids: string[] }) {
  return (
    <li data-cid={cids[0]} className="list-item flex items-start gap-3 2xl:hidden" style={{ listStyleType: "none", marginBottom: "calc(0.25rem - 0.1em)" }}>
      ...
      <span data-cid={cids[1]} className="text-sm text-muted-foreground whitespace-pre-wrap 2xl:hidden">
        {d.description}
      </span>
    </li>
  );
