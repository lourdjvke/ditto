...
export default function ListRow({ d, cids }: { d: ListRowData; cids: string[] }) {
  return (
    <li data-cid={cids[0]} className="list-item flex items-center gap-2 mb-1 2xl:hidden" style={{ listStyleType: "none" }}>
      <svg className="w-3.5 h-3.5 shrink-0" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
